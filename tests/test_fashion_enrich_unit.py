...
from backend import fashion_enrich
from backend.fashion_enrich import (
    FASHION_SCHEMA,
...
def test_from_env_falls_back_to_ngc_key(monkeypatch):
    ...
    assert VLMConfig.from_env().api_key == "ngc-key"
