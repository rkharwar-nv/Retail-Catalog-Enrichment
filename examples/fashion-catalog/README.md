...
Real output from `scripts/rebuild_catalog.py` over a 218-row merchant CSV. These
...
is called. See
[Rebuilding a catalog without re-running enrichment](../../docs/FASHION_CONFLICT_RESOLUTION.md#rebuilding-a-catalog-without-re-running-enrichment)
for the command.
